...
| 边云监控与告警控制中心 | [API文档](./api/边云监控与告警控制中心/API文档.md) | 面向边缘节点与设备的运行总览、实时告警、历史、策略、硬件控制与任务协同契约 |
...
| 边云监控与告警控制中心 | [设计方案](./design/边云监控与告警控制中心/设计方案.md) | 面向边缘节点与设备的运行总览、实时告警、告警历史、策略与硬件控制中心 |
...
| 2026-05-08 | 将“统一监控中心”重构为“边云监控与告警控制中心”，同步调整主题索引 | 用户补充“主要是边缘端、设备端结合云平台自身，infra 未来可能舍弃” |
| 2026-05-08 | 新增“边云监控与告警控制中心”API 文档并补充主题索引 | 用户要求“接口的话直接生成API规范文档” |
