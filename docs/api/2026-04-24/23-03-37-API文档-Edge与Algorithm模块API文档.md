# Edge 边缘模块 & Algorithm 算法模块 API 文档

> 本文档基于 vmesh-module-edge 与 vmesh-module-algorithm 后端 Controller + 前端 API SDK 源文件整理生成。
>
> 生成日期：2026-04-24
...
### Algorithm 算法模块
9. [算法管理](#21-算法管理-algorithm-controller)
10. [发布管理](#22-发布管理-publish-controller)
11. [算法配置管理](#23-算法配置管理-algorithm-config-controller)
...
### 2.3 算法配置管理 (Algorithm Config Controller)
...
| algorithm | Algorithm Controller | [AlgorithmController.java](/Users/yo/项目/ai_vision/cloud_agent/cloud/vmesh-module-algorithm/src/main/java/com/wf/vmesh/module/algorithm/controller/admin/AlgorithmController.java) |
| algorithm | Publish Controller | [PublishController.java](/Users/yo/项目/ai_vision/cloud_agent/cloud/vmesh-module-algorithm/src/main/java/com/wf/vmesh/module/algorithm/controller/admin/PublishController.java) |
| algorithm | Config Controller | [AlgorithmConfigController.java](/Users/yo/项目/ai_vision/cloud_agent/cloud/vmesh-module-algorithm/src/main/java/com/wf/vmesh/module/algorithm/controller/admin/AlgorithmConfigController.java) |
